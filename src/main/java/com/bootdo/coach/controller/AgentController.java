...
import com.bootdo.coach.vo.TabTopAgentVo;
...
//	@GetMapping("/agent1List")
//	@RequiresPermissions("coach:agent:agent1")
//	public List<TabAgentVo>  agent1List(@RequestParam String limit,@RequestParam String offset,@RequestParam String agentName) {
//		// 查询列表数据
...
//			agentService.updateAgentLevelAndHigherAgentId(agent.getAgentId(), agent.getHigherAgentId());
	...
	private void addUser(String agentName, String userName, String password){
		...
		user.setStatus(1);
		//{"deptName":"","email":"lifaqiu@163.com","username":"测试","password":"25bb7c42604b0e7aba7bcae50e7762a9","roleIds":[60],"status":1,"username":"test"}
